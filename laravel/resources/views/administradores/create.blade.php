...
@extends('templates.main', ['titulo' => "Novo Administrador"])
...
@section('conteudo')
    ...
    <form action="{{ route('administradores.store') }}" method="POST">
        @csrf
        <!-- Linha de inserir nome no administrador -->
            <div class="row">
                <div class="col" >
            ...
            <!-- Linha de inserir senha do administrador -->
            <div class="row">
                <div class="col">
                    <a href="{{route('administradores.index')}}" class="btn btn-secondary btn-block align-content-center">
