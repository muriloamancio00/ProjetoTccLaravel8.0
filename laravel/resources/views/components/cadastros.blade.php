    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card" style="width: 300px;">
                <div class="card-header" style="display: flex;justify-content:center;align-items: center;background-color: rgba(58,212,171,0.38)">
                    <h3>Cadatrar Dados</h3>
                </div>
                <div class="card-body">
                    <div class="list-group">
                        <a style="display: flex;justify-content:center;align-items: center;" href="{{ route('gerencia.administrador.create') }}" class="list-group-item list-group-item-action">Administradores</a>
                        <a style="display: flex;justify-content:center;align-items: center;" href="{{ route('gerencia.feirante.create') }}" class="list-group-item list-group-item-action">Feirantes</a>
                        <a style="display: flex;justify-content:center;align-items: center;" href="{{ route('gerencia.feirante.create') }}" class="list-group-item list-group-item-action">Eventos</a>
        ...
        <div class="col-md-4">
            <div class="card" style="width: 300px;">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a style="display: flex;justify-content:center;align-items: center;" href="{{ route('gerencia.feiras.create') }}" class="list-group-item list-group-item-action">Novas Rotas Evento</a>
