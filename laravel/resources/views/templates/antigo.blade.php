...
<div class="container py-4">
    ...
    <div class="container mt-4">
        ...
        <p>Esta é uma mensagem de boas-vindas. Aqui você encontrará informações sobre a minha página.</p>

        <div class="row mt-4">
            <div class="col-md-6">
                <h2>Seção 1</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vel velit quam. Fusce quis tincidunt felis. Nulla facilisi. Suspendisse sagittis ante felis, a pretium mauris bibendum nec.</p>
            </div>
            <div class="col-md-6">
                <h2>Seção 2</h2>
                <p>Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Pellentesque in ipsum id orci porta dapibus. Sed porttitor lectus nibh. Pellentesque in ipsum id orci porta dapibus.</p>
            </div>
        </div>
    </div>
</div>
