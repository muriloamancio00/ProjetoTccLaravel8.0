...
<html lang="pt-br">
    <head>
        ...
        <title>IFPR Paranaguá - @yield('titulo')</title>
            ...
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                        ...
                        <span class="ms-3 fs-5">IFPR Paranaguá</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('')}}" class="dropdown-item">Eixo</a></li>
                                <li><a href="{{route('')}}" class="dropdown-item">Curso</a></li>
                                <li><a href="{{route('')}}" class="dropdown-item">Professores</a></li>
                                <li><a href="{{route('')}}" class="dropdown-item">Diciplinas</a></li>
                                <li><a href="{{route('')}}" class="dropdown-item">Docencia</a></li>
                            </ul>
                        </li>
